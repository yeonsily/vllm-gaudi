...
class HpuMiniMaxM2DecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.self_attn = HpuMiniMaxM2Attention(
        ...
        self.block_sparse_moe = HpuMiniMaxM2MoE(
            config=config,
            quant_config=quant_config,
            prefix=f"{prefix}.mlp",
        )
...
class HpuMiniMaxM2Model(nn.Module):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: HpuMiniMaxM2DecoderLayer(
                config,
                prefix,
...
class HpuMiniMaxM2ForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.model = HpuMiniMaxM2Model(vllm_config=vllm_config, prefix=maybe_prefix(prefix, "model"))
        if get_pp_group().is_last_rank:
